...
@Component({
    ...
    templateUrl: 'account-cases.template.html',
    styleUrls: ['./account-cases.style.css'],
})
...
export class AccountCaseComponent implements OnInit {
    ...
    loadPage(page) {
        ...
        if (typeof page === 'number') {
            ...
            component._accountService.getAccountCases(component.accountId, component.listAttr).subscribe(
                response => {
                    component.caseList = response;
                }, error => {
